export function generateOpenAPISpec(): {
    ...
    return {
        ...
        info: {
            title: "Orbit API",
            description:
                "API for managing job applications, documents, and authentication",
            version: "1.0.0"
        },
        servers: [
        ...
        tags: [
            ...
            { name: "Applications", description: "Job application management" },
            {
                ...
                description: "Document attachments to applications"
            },
            {
                name: "Documents",
        ...
        paths: {
            ...
            "/api/v1/applications/document-counts": {
                get: {
                    ...
                    description:
                        "Get the number of documents attached to specified applications",
                                ...
                                schema: {
                                    ...
                                    properties: {
                                        documentVersionId: {
                                            type: "string",
                                            description:
                                                "ID of the document version to attach"
                                        }
                                    }
                                }
                            }
            ...
            "/api/v1/applications/{id}/documents/{attachmentId}": {
                delete: {
                    ...
                    description:
                        "Remove a document attachment from an application",
                    ...
                    responses: {
                        200: { description: "Document detached successfully" }
                    },
                    security: [{ bearerAuth: [] }]
                }
            },
            ...
            "/api/v1/documents": {
                get: {
                    ...
                    description:
                        "Retrieve a paginated list of user's documents",
                    ...
                    parameters: [
                        ...
                        },
                        {
                            ...
                            schema: { type: "string" },
                            description:
                                "Filter by document type (CV, COVER_LETTER, OTHER)"
                        }
                    ],
                    responses: {
            ...
            "/api/v1/documents/{id}/versions": {
                post: {
                    ...
                    responses: {
                        201: { description: "Version uploaded successfully" }
                    },
                    security: [{ bearerAuth: [] }]
                }
            },
            ...
            "/api/v1/documents/{id}/versions/{versionId}/preview": {
                get: {
                    ...
                    description:
                        "Get a preview URL for a specific version of a document",
